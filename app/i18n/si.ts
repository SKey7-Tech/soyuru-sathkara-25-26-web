export const si = {
  hero: {
    ...
    papersBtn: "පසුගිය ප්‍රශ්න පත්‍ර",
  ...
  papers: {
    ...
    items: {
      "paper-2024-biology": {
        ...
        description: "ජී.සී.ඊ උ.පෙළ ජීව විද්‍යාව විභාග ප්‍රශ්න පත්‍රය 2024"
      },
      "paper-2024-physics": {
        title: "භෞතික විද්‍යාව 2024 ප්‍රශ්න පත්‍රය",
        description: "ජී.සී.ඊ උ.පෙළ භෞතික විද්‍යාව විභාග ප්‍රශ්න පත්‍රය 2024"
      },
      "paper-2024-chemistry": {
        title: "රසායන විද්‍යාව 2024 ප්‍රශ්න පත්‍රය",
        description: "ජී.සී.ඊ උ.පෙළ රසායන විද්‍යාව විභාග ප්‍රශ්න පත්‍රය 2024"
      }
    }
  },
  theory: {
  ...
  shortNotes: {
    ...
    items: {
      "short-biology-quick": {
        title: "ජීව විද්‍යාව ඉක්මන් සංශෝධනය",
        description: "ඉක්මන් සමාලෝචනය සඳහා අත්‍යවශ්‍ය ජීව විද්‍යා සංකල්ප"
      },
